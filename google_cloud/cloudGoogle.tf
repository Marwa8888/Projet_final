...
// resource "google_compute_address" "internal_ip1" {
...
resource "google_compute_subnetwork" "subnetclient" {
  name          = "${var.subnet3}"
  ip_cidr_range = "10.3.0.0/16"
  region        = "${var.regionsubnet3}"
  network       = "${google_compute_network.network.self_link}"
}

// resource "google_compute_address" "internal_ip2" {
//   name         = "my-internal-address"
...
resource "google_compute_instance" "client" {
  ...
  network_interface {
    network = "${google_compute_network.network.self_link}"
    subnetwork = "${google_compute_subnetwork.subnetclient.self_link}"
